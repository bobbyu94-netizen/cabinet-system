...
This document defines the standard labor assumptions used for cabinet estimating, production planning, scheduling, and future automation.

These standards are intended to serve as the baseline labor model for all cabinet projects unless overridden by project-specific requirements.

Actual labor times should be tracked separately and used to refine these standards over time.
...
Labor is separated into the following categories:

| Category            | Description                                    |
| ------------------- | ---------------------------------------------- |
| Design              | Layout, revisions, renderings, CNC preparation |
| Material Processing | Sheet breakdown, CNC cutting, edge banding     |
| Assembly            | Cabinet assembly, drawer assembly, hardware    |
| Finishing           | Sanding, prep, priming, painting               |
| Installation        | Delivery, installation, trim, touch-up         |
...
* Normal residential installation conditions
* No plumbing or electrical modifications
...
These are job-level and unit-level rates used for overhead tasks and non-standard calculations. For standard cabinet estimates, use the per-cabinet tables under Cabinet Standards — those are the authoritative source. Individual cutting and routing rates are applied per unit (per cabinet, per door, or per drawer) as noted.

| Operation             | Unit        | Standard Time |
| --------------------- | ----------- | ------------: |
| Initial Design        | Per Job     |       1.0 hrs |
| Material Pickup       | Per Trip    |       1.5 hrs |
| Plywood Cutting       | Per Cabinet |      0.50 hrs |
| Face Frame Cutting    | Per Cabinet |      0.50 hrs |
| Face Frame Assembly   | Per Cabinet |      0.50 hrs |
| Pocket Holes          | Per Cabinet |      0.50 hrs |
| Door Cutting          | Per Door    |      0.50 hrs |
| Door Routing          | Per Door    |      0.50 hrs |
| Drawer Cutting        | Per Drawer  |      0.50 hrs |
| Drawer Routing        | Per Drawer  |      0.50 hrs |
...
Door Cutting and Door Routing are per door (2 doors shown). Drawer Cutting and Drawer Routing are per drawer (1 drawer shown).

| Operation           |     Time |
| ------------------- | -------: |
| Plywood Cutting     | 0.50 hrs |
| Face Frame Cutting  | 0.50 hrs |
| Door Cutting        | 1.00 hrs |
| Door Routing        | 1.00 hrs |
| Drawer Cutting      | 0.50 hrs |
| Drawer Routing      | 0.50 hrs |
| Face Frame Assembly | 0.50 hrs |
| Pocket Holes        | 0.50 hrs |
...
| ------------------- | ------------------- | -------------------------------------------------------------- |
| Plywood Cutting     | No                  | Flat rate per cabinet                                          |
| Face Frame Cutting  | No                  | Flat rate per cabinet                                          |
| Door Cutting        | No                  | Flat rate per door                                             |
| Door Routing        | No                  | Flat rate per door                                             |
| Drawer Cutting      | No                  | Flat rate per drawer                                           |
| Drawer Routing      | No                  | Flat rate per drawer                                           |
| Face Frame Assembly | Yes                 | Wider face frames have more joints and more squaring time      |
| Pocket Holes        | Yes                 | More joints on wider cabinets                                  |
...
| ------------------- | -------------------- | ------------: |
| Plywood Cutting     | 0.50 x 1.00          |      0.50 hrs |
| Face Frame Cutting  | 0.50 x 1.00          |      0.50 hrs |
| Door Cutting        | (0.50 x 2) x 1.00    |      1.00 hrs |
| Door Routing        | (0.50 x 2) x 1.00    |      1.00 hrs |
| Drawer Cutting      | (0.50 x 1) x 1.00    |      0.50 hrs |
| Drawer Routing      | (0.50 x 1) x 1.00    |      0.50 hrs |
| Face Frame Assembly | 0.50 x 1.10          |      0.55 hrs |
| Pocket Holes        | 0.50 x 1.10          |      0.55 hrs |
...
Total: 8.325 hours, rounded to 8.33 hours.
...
Door Cutting and Door Routing are per door (2 doors shown for cabinets ≥ 24" wide).
...
| 19 to 23 inches   |          1.00 | Baseline — single door                                                       |
| 24 to 36 inches   |          1.10 | Double door starts here — more parts, more assembly time                     |
...
| Door Cutting        | No                  | Flat rate per door                                       |
| Door Routing        | No                  | Flat rate per door                                       |
| Face Frame Assembly | Yes                 | Wider face frames have more joints and squaring time     |
| Pocket Holes        | Yes                 | More joints on wider cabinets                            |
...
Door Cutting and Door Routing are per door (2 doors shown).
...
| Operation              |     Time |
| ---------------------- | -------: |
| Leveling and Fastening | 1.25 hrs |
| Hardware Adjustment    | 0.25 hrs |
...
| Operation             |     Time |
| --------------------- | -------: |
| Hanging and Alignment | 1.00 hrs |
| Hardware Adjustment   | 0.25 hrs |
...
| Operation               |     Time |
| ----------------------- | -------: |
| Placement and Fastening | 2.00 hrs |
| Hardware Adjustment     | 0.25 hrs |
...
These multipliers are intended to adjust labor estimates for increased project difficulty.
...
Actual labor hours should be tracked separately from estimated labor.

The following information should be recorded for every completed project:
...
* Notes on delays or inefficiencies
...
Initial labor standards document created for baseline estimating and future automation support.

Labor values are preliminary estimates and should be refined using real project data over time.
